...
public class POMLoginStep {
	...
	public void clicks_on_login_button() throws InterruptedException {
	  ...
	  public void Room_Add() throws InterruptedException 
	  {
		  // Write code here that turns the phrase above into concrete actions 
		  System.out.println("Room_Add_passed");
		  driver.findElement(By.xpath("//button[normalize-space()='Room Add']")).click();
		  //Assert.assertTrue(driver.findElements(By.xpath("//button[normalize-space()='Room Add']")).size()>0,"user is navigated to the home page");
	  }
	  
	  @Then("clicks on Edit_and_Update") 
	  public void Edit_and_Update() throws InterruptedException 
	  {
		  // Write code here that turns the phrase above into concrete actions 
